...
public class HttpDiscovery implements PeerDiscovery {
	...
	/**
	 * Constructs a discovery object that will read data from the given HTTP[S] URI
	 * and, if a public key is provided, will check the signature using that key.
	 */
	...
	/**
	 * InetSocketAddress用来描述IP地址和主机名称。 当然，它也支持使用常规方法来检查地址：回环地址、本地地址、组播地址；
	 * 基本的返回方法：ip\port\hostname
	 * 
	 * @ref https://blog.csdn.net/wo541075754/article/details/66971888
	 */
	@Override
	...
	public InetSocketAddress[] protoToAddrs(PeerSeedProtos.SignedPeerSeeds proto)
			throws PeerDiscoveryException, InvalidProtocolBufferException, SignatureException {
